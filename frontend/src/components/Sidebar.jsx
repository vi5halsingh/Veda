...
export default function Sidebar({ onSelectChat, selectedChatId, socket, isOpen, setIsOpen }) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed sm:relative z-50 border-r border-[#404040] h-screen bg-[#0f0f0f] text-[#f3f4f6] flex flex-col transition-all duration-300 ease-in-out ${isMinimized ? "w-16" : "w-72"
